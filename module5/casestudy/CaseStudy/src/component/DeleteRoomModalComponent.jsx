...
import {deleteRoom} from "../service/RoomService.js";
...
const DeleteRoomModalComponent = ({show, handleToggleModal, objectDelete, reloadAfterDelete}) => {
    ...
    const handleDeleteRoom = () => {
        const fetchData = async () => {
            const isDeleteSucceed = await deleteRoom(objectDelete?.id);
            if (isDeleteSucceed) {
    ...
    return (
        <Modal show={show} onHide={handleToggleModal} centered>
            ...
            <Modal.Footer className="border-0 d-flex justify-content-between">
                ...
                <Button variant="danger" className="px-4" onClick={handleDeleteRoom}>
                    Xóa
                </Button>
            </Modal.Footer>
        </Modal>
