...
const AddComponent = () => {
    ...
    const handleAdd = (values) => {
        const newPlayer = {...values, gia: Number(values.gia)}
                        ...
                        <div className="card shadow-sm border-0 rounded-4 overflow-hidden">
                            <div className="card-body p-4 p-md-5">
                                ...
                                <div className="d-flex justify-content-between align-items-center mb-4">
                                    ...
                                    <Link to="/players" className="text-decoration-none small">Quay lại danh sách</Link>
                                </div>
                                        ...
                                        <Form>
                                            <div className="row g-4">
                                                <div className="col-12 col-md-4 d-flex flex-column align-items-center">
                                                    ...
                                                    <h6 className="mb-0 text-center">{values.ten || "Tên cầu thủ"}</h6>
                                                    <small className="text-muted">Mã: {values.maCauThu || "-"}</small>
                                                </div>
                                                ...
                                                <div className="col-12 col-md-8">
                                                    <div className="row g-3">
                                                        ...
                                                        <div className="col-12">
                                                            <label className="form-label small fw-semibold">Họ và
                                                        ...
                                                        <div className="col-6">
                                                            <label className="form-label small fw-semibold">Mã cầu
                                                                thủ <span className="text-danger">*</span></label>
                                                            <Field
                                                                name="maCauThu"
                                                                ...
                                                                autoComplete="off"
                                                            />
                                                            <ErrorMessage name="maCauThu" component="div"
                                                                          className="text-danger small mt-1"/>
                                                        </div>

                                                        <div className="col-12 col-sm-6">
                                                            <label className="form-label small fw-semibold">Ngày
                                                                sinh <span className="text-danger">*</span></label>
                                                            <Field
                                                                name="ngaySinh"
                                                                type="date"
                                                                className="form-control"
                                                            />
                                                            <ErrorMessage name="ngaySinh" component="div"
                                                                          className="text-danger small mt-1"/>
                                                        </div>

                                                        <div className="col-12 col-sm-6">
                                                            <label className="form-label small fw-semibold">Giá trị
                                                                (VND) <span className="text-danger">*</span></label>
